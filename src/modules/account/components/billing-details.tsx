      ...
      <div className="flex w-full flex-col gap-4">
        ...
        >
          <div className="px-5 py-4 text-main dark:text-main-dark">
            <h3 className="pb-4 text-main font-semibold flex flex-wrap items-center gap-x-2">
              ...
              <div
                className={cn(
                  ...
                  planType === "Premium" || planType === "Premium Plus"
                    ...
                    : "bg-white dark:bg-full-dark border border-gray-300 dark:border-[#123a6f] text-main-h dark:text-main-dark"
                )}
              >
                {planType}
              </div>
            ...
            <div className="flex flex-col w-full md:w-fit gap-2 sm:ml-auto sm:flex-row">
              {planType !== "Gratis" && !isSubscriptionIncomplete && (
                <Button
                  ...
                  className="w-full md:w-fit shadow-sm text-red-500 dark:text-red-500/80 bg-white dark:bg-full-dark border border-red-500 dark:border-red-500/80 data-[hover=true]:bg-red-500 data-[hover=true]:dark:bg-red-500/80 data-[hover=true]:text-white data-[hover=true]:dark:text-white font-medium text-sm"
                >
