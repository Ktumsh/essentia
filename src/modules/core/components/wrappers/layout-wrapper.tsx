  ...
  const backgroundClasses = useMemo(() => {
    if (!isPremium && !isProfile && !isAccount) {
      return cn(
        ...
        "before:dark:h-[300px] sm:before:dark:h-[600px] before:dark:w-[980px] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-[#ff7373] before:dark:opacity-20",
        ...
        "after:dark:top-1/4 after:dark:left-2/3 after:dark:h-[80px] sm:after:dark:h-[180px] after:dark:w-[260px] after:dark:bg-gradient-to-br after:dark:from-base-full-dark after:dark:via-[#ff7373] after:dark:opacity-50 after:dark:blur-3xl after:dark:rounded-none",
