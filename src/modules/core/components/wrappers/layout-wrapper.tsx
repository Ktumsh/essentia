  ...
  const backgroundClasses = useMemo(() => {
    if (!isPremium && !isProfile && !isAccount) {
      return cn(
        ...
        "after:dark:top-1/4 after:dark:left-2/3 after:dark:h-[80px] sm:after:dark:h-[180px] after:dark:w-[260px] after:dark:bg-gradient-to-br after:dark:from-full-dark after:dark:via-[#ff7373] after:dark:opacity-0 md:after:dark:opacity-50 after:dark:blur-3xl after:dark:rounded-none",
        isAIorShare &&
      ...
      return cn(
        ...
        "after:dark:top-1/4 after:dark:left-1/2 after:dark:h-[180px] after:dark:w-[260px] after:dark:bg-gradient-to-br after:dark:from-full-dark after:dark:via-[#ff7373] after:dark:opacity-80 after:dark:blur-3xl after:dark:rounded-none"
      );
    }
