...
const NutritionCarouselItem = ({ item }: Props) => {
  ...
  return (
    <>
      ...
      >
        <div className="h-full rounded-sm border border-altern-accent bg-altern p-2.5 dark:border-accent-dark dark:bg-dark">
          <div className="relative overflow-hidden rounded-sm">
            ...
            <div className="absolute inset-0 z-10 p-4">
              <div className="flex h-full translate-y-full flex-col rounded-sm bg-gray-100/80 transition-transform duration-300 will-change-transform group-hover:translate-y-0 dark:bg-gray-900/90">
                ...
                <div className="mx-auto flex h-full items-center justify-center">
                  <Button
                    ...
                    className="rounded-xs border border-main font-spacemono font-semibold uppercase text-main will-change-transform hover:bg-main! hover:text-white dark:border-main-dark dark:text-white dark:hover:bg-white! dark:hover:text-main"
                  >
                    Ver receta
                  </Button>
                </div>
