  ...
  return (
    <Card radius="md" className="space-y-5 p-8 bg-white dark:bg-base-full-dark">
      ...
      <div className="flex justify-around">
        <Skeleton className="w-1/4 bg-gray-200 dark:bg-base-dark rounded-full before:!duration-1000">
          <div className="h-36 rounded-lg bg-default-200"></div>
        </Skeleton>
...
export default HealthRiskSkeleton;
