  ...
  return (
    <div className="w-full flex items-stretch justify-center grow lg:px-8 md:pb-0 pt-14 shrink">
      <main className="flex flex-col size-full max-w-5xl py-5 pb-12 lg:pb-5 lg:px-5 shrink items-stretch grow">
        ...
        <div className="flex flex-col relative w-full mt-5 pt-4 pb-14 md:pt-0 md:pb-0 select-none bg-gray-100 dark:bg-base-dark-50 md:bg-transparent md:dark:bg-transparent rounded-t-3xl md:rounded-none">
