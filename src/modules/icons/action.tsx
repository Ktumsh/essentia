...
const BugIcon = (props: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
    ...
    >
      <g
        ...
        color="currentColor"
      >
        <path d="M3.012 6.598c-.12 1.059.646 3.597 2.865 3.657m12.413-.06c1.078.06 2.697-1.199 2.697-3.597m-.899 14.39c.06-1.379-.84-3.514-2.579-3.573M3.901 20.988c-.061-1.388.858-3.537 2.636-3.597m-3.525-3.598h2.206m15.782 0h-2.172m-6.835 0v-2.938M16.49 3l-1.799 1.799M7.496 3l1.799 1.799M6.956 8.612c1.619 1.164 5.636 2.842 10.013.072" />
        <path d="M16.826 7.677c-3.574-4.977-8.13-2.578-9.75.144c-1.055 1.775-2.698 6.068.42 10.745c3.358 4.1 7.315 2.242 8.934.084c1.56-1.86 3.094-6.656.396-10.973" />
      </g>
    </svg>
  );
};

function CopyIcon(props: IconSvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
const EditIcon = (props: IconSvgProps) => {
  return (
    <svg fill="none" height="24" viewBox="0 0 20 20" width="24" {...props}>
      <path
...
const HelpIcon = (props: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
const ClearIcon = (props: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
const ShareIcon = (props: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
const PlayIcon2 = (props: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
const NewIcon = (props: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 256 256"
...
const NewChatIcon = (props: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
const UploadIcon = (props: IconSvgProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="32"
