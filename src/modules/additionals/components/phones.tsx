...
const Phones = () => {
  return (
    <section className="mt-5 flex flex-col items-center">
      ...
      <div className="grid gap-2 md:grid-cols-12 md:px-0">
        {PHONES.map((phone, index) => (
          <Card
            ...
            shadow="none"
            className={cn(
              "group border border-gray-200 bg-white text-main-h dark:border-dark dark:bg-full-dark dark:text-white sm:col-span-4 md:dark:border-dark",
            )}
          >
