...
import CancelSubscriptionModal from "@/modules/account/components/cancel-subscription-modal";
import {
  getPaymentStatus,
  getPlanStatus,
  getPlanType,
} from "@/modules/account/lib/utils";
                    ...
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="text-main-h dark:text-main-dark-h">
                          <div className="flex items-center gap-1.5">
                            <HandCoins strokeWidth={1.5} className="size-3" />
                            <span className="text-nowrap">Monto</span>
                          </div>
                        </TableHead>
                        <TableHead className="text-main-h dark:text-main-dark-h">
                          <div className="flex items-center gap-1.5">
                            <Banknote strokeWidth={1.5} className="size-3" />
                            <span className="text-nowrap">Divisa</span>
                          </div>
                        </TableHead>
                        <TableHead className="text-main-h dark:text-main-dark-h">
                          <div className="flex items-center gap-1.5">
                            <Stars strokeWidth={1.5} className="size-3" />
                  ...
                  <div className="py-10 text-center">
                    <div className="flex flex-col items-center justify-center gap-4 text-main-m dark:text-main-dark-m">
                      ...
                      <Button
                        ...
                        className="h-fit p-0 text-sm font-medium text-blue-600 hover:underline"
                      >
                        Hazte premium
                      </Button>
                    </div>
