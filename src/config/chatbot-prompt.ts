...
export const createSystemPrompt = ({
  ...
  - Instrucciones Generales:
    ...
    - Si consideras proporcionar más de una herramienta en base a su pregunta, no dudes en preguntarle al usuario de manera directa y amable si desea otra herramienta antes de preguntarle datos.
    - Asegúrate de siempre proporcionar una sóla herramienta independientemente si el usuario te mencione más de una.
