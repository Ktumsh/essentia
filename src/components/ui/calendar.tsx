  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-danger text-white hover:bg-danger hover:text-white focus:bg-danger focus:text-white dark:bg-danger dark:text-danger dark:hover:bg-danger dark:hover:text-white dark:focus:bg-danger dark:focus:text-white",
        day_today: "bg-gray-100 text-main dark:bg-dark/50 dark:text-white",
        day_outside:
