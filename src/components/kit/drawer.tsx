    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=right]:overflow-hidden data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0 data-[vaul-drawer-direction=top]:mb-24 data-[vaul-drawer-direction=top]:max-h-[80vh] data-[vaul-drawer-direction=top]:rounded-b-lg",
        ...
        {...props}
      >
        <div className="dark:bg-alternative/50 mx-auto mt-1.5 hidden h-1 w-10 shrink-0 rounded-full bg-slate-200 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <header
      ...
      className={cn(
        "border-border flex flex-col gap-1.5 border-b text-center md:text-left",
        className,
      )}
      {...props}
    />
