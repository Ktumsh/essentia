        ...
        >
          ...
          <div className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            <motion.div
              ...
              className="shadow-pretty bg-background transform rounded-2xl p-6 text-start transition-all duration-300 hover:-translate-y-1"
            >
          ...
          {!session?.user && (
            <div className="shadow-pretty bg-background mx-auto mt-16 max-w-3xl rounded-2xl p-8">
